...
// ParseRadians parses s as decimal degrees.
...
// Degrees converts r into Degrees.
func (r Radians) Degrees() Degrees {
	return Degrees(r * 180.0 / math.Pi)
}

// Turns converts r into Turns.
func (r Radians) Turns() Turns {
	return Turns(r / 2 / math.Pi)
}

// Turns represents a latitude or longitude, in the number of turns around a
// sphere.
type Turns float64
